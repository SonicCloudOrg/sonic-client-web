...
describe('Cookie', () => {
    ...
    it('can be created from a protocol Cookie with no optional fields set', () => {
        ...
        assert.strictEqual(cookie.sourceScheme(), "NonSecure" /* Protocol.Network.CookieSourceScheme.NonSecure */);
    });
    ...
    it('can set initialize with a different priority', () => {
        const cookie = new SDK.Cookie.Cookie('name', 'value', null, "High" /* Protocol.Network.CookiePriority.High */);
