...
export class SettingTracker {
    ...
    #trackConsoleInsightSettingChange() {
    ...
    #syncConsoleInsightSettingsWithQueryParams() {
        const toggledSetting = Common.Settings.Settings.instance().createLocalSetting(consoleInsightsToggledSettingName, false);
...
//# sourceMappingURL=SettingTracker.js.map