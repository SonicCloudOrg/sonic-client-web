...
describeWithMockConnection('StylePropertyHighlighter', () => {
    ...
    function createSection(stylesSidebarPane, matchedStyles, sectionName, propertyName) {
        ...
        if (propertyName) {
            const property = new SDK.CSSProperty.CSSProperty(style, 0, propertyName, 'value', true, false, true, false, '', undefined);
        ...
        return new Elements.StylePropertiesSection.StylePropertiesSection(stylesSidebarPane, matchedStyles, style, 
