...
declare const LayerTreeOutline_base: (new (...args: any[]) => {
    ...
    dispatchEventToListeners<T_3 extends Events.PaintProfilerRequested>(eventType: import("../../core/platform/TypescriptUtilities.js").NoUnion<T_3>, ...eventData: Common.EventTarget.EventPayloadToRestParameters<EventTypes, T_3>): void;
