...
Response status: 404 Not found`);
    ...
    describe('formatRelatedCode', () => {
        it('formats a single line code', () => {
            assert.strictEqual(Explain.formatRelatedCode({
...
export const y = "";
`;
            assert.strictEqual(Explain.formatRelatedCode({ text, columnNumber: 4, lineNumber: 11 }, /* maxLength=*/ 233), '  // x\n  if (true) {\n    // y\n\n    // zzzzzz\n  }\n\n  let y = x + 2;\n\n  if (false) {\n    // a\n\n    f1();\n    if (x == x) {\n      // z\n    }\n  }');
            assert.strictEqual(Explain.formatRelatedCode({ text, columnNumber: 4, lineNumber: 11 }, /* maxLength=*/ 232), '  // x\n  if (true) {\n    // y\n\n    // zzzzzz\n  }\n\n  let y = x + 2;');
            assert.strictEqual(Explain.formatRelatedCode({ text, columnNumber: 4, lineNumber: 11 }, /* maxLength=*/ 600), text.trim());
            assert.strictEqual(Explain.formatRelatedCode({ text, columnNumber: 4, lineNumber: 11 }, /* maxLength=*/ 50), '  // x\n  if (true) {\n    // y\n\n    // zzzzzz\n  }');
            assert.strictEqual(Explain.formatRelatedCode({ text, columnNumber: 4, lineNumber: 11 }, /* maxLength=*/ 40), '  // x');
            assert.strictEqual(Explain.formatRelatedCode({ text, columnNumber: 4, lineNumber: 18 }, /* maxLength=*/ 50), '  let y = x + 2;');
        });
    });
