...
const stepDetail = {
  ...
  coordinateControl: 'Coordinate Control',
    ...
    androidOptions: {
      ...
      element: {
        ...
        uiEle: {
          ...
          obtainElementAttr: 'Get Element Attrbitute',
  ...
  msg: {
    ...
    startPkgName: 'Please enter the App package name that you want to start',
    ...
    branchName:
      'Please enter the branch name, it could be leave as blank, fuzzy matching is supported',
    uninstallPkgName: 'Please intstall the App package name to be uninstalled',
    ...
    processName:
      '(Selectlable)Please enter the process containning the WebView, default to the package name',
  ...
  msgTips: {
    variable:
      'TIPS: Add {{variable}} when temporary variable or global variable is needed',
    install:
    ...
    sysKey:
      'TIPS: Wakeup the system keyboard first, add {{variable}} if temporary variable or global variable is needed',
    table:
    ...
    verify:
      'TIPS: Use {{variable}}to insert global variable or temporary variable, it would be replaced by the variable value during verification',
    order:
  ...
  startPocoDriver: 'Start POCO Driver',
  swipe: 'Swipe',
  switch: {
  ...
  unknownRollSideType: 'UnKnown Rolling Side and type',
  upwards: 'upwards',
  userDoc: 'User Document',
  variable: 'Variable',
  varibaleName: 'Variable Name',
  verify: {
