...
<template>
  ...
  <el-alert style="margin-bottom: 10px" title="cssSelectorAndText类型，可以通过cssSelector和控件中Text定位控件元素" type="info" show-icon close-text="Get!"/>
  <el-form ref="updateEle" :model="element" size="small" class="demo-table-expand" label-width="90px"
    ...
    <el-alert style="margin-bottom: 10px" title="如选择cssSelectorAndText类型，vaule之间用|隔开，例：.van-button--default|购物车" type="info" show-icon close-text="Get!"/>          
